          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-6">
                An ZenaTrust Representative will work with you to <strong>assess</strong> your unique situation and point you toward 
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700">
                    Through ZenaTrust, we offer access to a range of investment options that reflect our 
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Contact an ZenaTrust Institutional Representative
              </p>
      ...
      <footer className="bg-[#03305c] text-white mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                ZenaTrust is committed to providing exceptional investment services to help you achieve your financial goals.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-600 mt-8 pt-8 text-center text-gray-300">
            <p>&copy; 2024 ZenaTrust. All rights reserved.</p>
