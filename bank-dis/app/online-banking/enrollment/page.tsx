        ...
        <div className="mb-16">
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-2/3">
                <p className="text-[#03305c] mb-4">
                  Transfer funds with ease through Online Banking. Move money between your Amalgamated Bank accounts as well as accounts held at other U.S. institutions. You can also schedule transfers of funds.
                </p>
                <div className="flex items-center text-[#03305c]">
