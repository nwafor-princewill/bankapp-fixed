...
const StoryContent = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-[#03305c] mb-8 text-center">
      ...
      <div className="space-y-6 text-[#03305c]">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>First bank to offer free checking accounts to working New Yorkers</li>
          <li>Provided second-chance accounts to those who needed a fresh start</li>
          <li>Created the first foreign-exchange transfer service for immigrant remittances</li>
        </ul>
        ...
        <p>
          Where you do business with your money is important to you, and the decisions you make about where you shop, what you eat and how you live are made consciously and with purpose. Why should where you bank be any different?
        </p>
